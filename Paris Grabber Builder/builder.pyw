...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Paris Grabber Builder")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Paris.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Paris.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Paris.png")), size=(20, 20))
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Paris Grabber Builder", image=self.logo_image,
